...
describe('Testing Chord Major', () => {
    ...
    test('Test Chord.Name', () => {
        expect(CMajor.Name).toBe('CMajor');
    });
...
describe('Testing Chord Minor', () => {
    var CMinor = new Chord(C, MusicDefs.ChordTypes.find(f => f.Name === 'Minor'));
    ...
    test('Test Chord.Display Minor', () => {
        expect(CMinor.Display).toBe('Cmin');
    });
...
describe('Test Chord Diminished', () => {
    var CDiminished = new Chord(C, MusicDefs.ChordTypes.find(f => f.Name === 'Diminished'));
    ...
    test('Test Chord.Display Diminished', () => {
        expect(CDiminished.Display).toBe('Cdim');
    });
...
describe('Test Chord Seventh', () => {
    ...
    test('Test Chord.Display Seventh', () => {
        expect(CSeventh.Display).toBe('C7');
    });
